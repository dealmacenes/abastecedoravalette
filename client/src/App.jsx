    ...
    <div className="font-sans text-[#222222] bg-[#F8F9FA] overflow-x-hidden min-h-screen font-montserrat scrollbar-none">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden md:flex space-x-8 items-center">
              <a href="#sucursales" className="text-gray-600 hover:text-[#E3343A] font-medium transition-colors">Sucursales</a>
              <a href="#mayoristas" className="text-gray-600 hover:text-[#E3343A] font-medium transition-colors">Mayoristas</a>
              <a href="#nosotros" className="text-gray-600 hover:text-[#E3343A] font-medium transition-colors">Nosotros</a>
              <button 
      ...
      >
        <div className="p-6 border-b border-gray-100 flex justify-between items-center">
          ...
          <button onClick={() => setIsSidebarOpen(false)} className="text-gray-400 hover:text-[#E3343A]">
            <X size={24} />
          </button>
        </div>
        
        <div className="p-6 flex-grow overflow-y-auto no-scrollbar space-y-8">
          <p className="text-gray-600 text-sm mb-6">Comunicate directamente con nuestras sucursales para atención personalizada, pedidos o consultas mayoristas.</p>
          ...
          <div className="bg-gray-50 rounded-2xl p-5 border border-gray-100 hover:shadow-md transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h4 className="font-bold text-[#2B3175]">Sucursal Luis Guillón</h4>
                <p className="text-xs text-gray-500">Av. Luciano Valette 1686</p>
              </div>
            </div>
            <a 
          ...
          <div className="mt-8 pt-8 border-t border-gray-100">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex items-center gap-2"><Check size={16} className="text-[#E3343A]" /> Cortes Vacunos, Cerdo y Pollo</li>
              <li className="flex items-center gap-2"><Check size={16} className="text-[#E3343A]" /> Venta por Mayor y Menor</li>
              <li className="flex items-center gap-2"><Check size={16} className="text-[#E3343A]" /> Precios de Productor Directo</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center">
          <div className="md:w-3/5">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-black leading-tight mb-6 tracking-tight">
              ABASTECEDORA <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300">VALETTE</span>
            </h1>
            <p className="text-xl md:text-2xl font-medium mb-8 border-l-4 border-[#E3343A] pl-4 text-gray-100 max-w-2xl">
              Una experiencia de compra directa; <br className="hidden md:block" />
              <span className="font-bold text-white">sin intermediarios.</span>
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#sucursales" className="bg-white text-[#2B3175] px-8 py-4 rounded-full font-bold text-center hover:bg-gray-100 hover:scale-105 transition-all shadow-xl">
                Ver Sucursales
              </a>
              <a href="#mayoristas" className="bg-[#E3343A] text-white px-8 py-4 rounded-full font-bold text-center hover:bg-[#c92a30] hover:scale-105 transition-all shadow-xl flex items-center justify-center gap-2">
      ...
      <section id="sucursales" className="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative -mt-10 z-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-5xl font-black text-[#2B3175] mb-4">Nuestras Sucursales</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">Visitanos y viví una experiencia de compra directa, con la mejor atención y los cortes más frescos de la zona.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgb(43,49,117,0.2)] transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div className="p-8">
              ...
              <p className="text-gray-600 flex items-start gap-3 mb-2">
                <MapPin className="mt-1 flex-shrink-0 text-[#E3343A]" size={18} />
                <span><strong>Av. Libertador 3910</strong><br /> Mercado Modelo Moreno</span>
              </p>
              <div className="mt-6">
                <a 
                  href="https://wa.me/541128353615" 
      ...
      <section id="mayoristas" className="bg-[#2B3175] py-20 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">¿Querés abrir tu comercio?</h2>
          <p className="text-xl text-gray-200 mb-10 max-w-3xl mx-auto font-medium">
            Te acompañamos en el crecimiento de tu negocio. Al ser productores directos y contar con criadero propio, te garantizamos frescura continua, abastecimiento seguro y los precios más competitivos del mercado en vacuno, cerdo y pollo.
          </p>
          
          <div className="bg-white/10 p-6 md:p-8 rounded-3xl backdrop-blur-md border border-white/20 inline-block">
            <p className="text-white mb-6 font-bold text-lg">Si tenés una carnicería, restaurante o supermercado, hablemos:</p>
            <a 
              href="https://wa.me/541128353615" 
              target="_blank" 
              rel="noopener noreferrer"
      ...
      <section id="nosotros" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-[#2B3175] mb-4">Nuestra Identidad</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl group h-full min-h-[400px]">
              ...
              <div className="absolute bottom-0 left-0 p-8">
                <div className="bg-[#E3343A] text-white text-sm font-bold px-4 py-2 rounded-lg inline-block mb-3">Productores Directos</div>
                <h3 className="text-3xl font-bold text-white leading-tight">Del campo a<br />tu mostrador.</h3>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-[#2B3175] mb-2">Nuestra Misión</h3>
                  <p className="text-gray-600 leading-relaxed text-justify">
                    Acercarte carne de calidad de forma directa, simple y conveniente. Como productores, trabajamos sin intermediarios para ofrecerte mejores precios, buena atención y una experiencia de compra clara, tanto si venís por tu compra diaria como si abastecés tu negocio.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-[#2B3175] mb-2">Nuestra Visión</h3>
                  <p className="text-gray-600 leading-relaxed text-justify">
                    Seguir creciendo y consolidarnos como un referente en el rubro, combinando nuestra experiencia como productores con herramientas tecnológicas que nos permitan estar más cerca de cada cliente y responder mejor a sus necesidades.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-[#2B3175] mb-2">Nuestros Valores</h3>
                  <p className="text-gray-600 leading-relaxed text-justify">
                    Nos guiamos por el compromiso, la responsabilidad y el respeto en cada venta. Apostamos a una atención cercana y personalizada, especialmente con nuestros clientes mayoristas, construyendo relaciones de confianza a largo plazo.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <img src="https://api.iconify.design/lucide:piggy-bank.svg?color=%23E3343A" alt="Cerdo" className="w-16 h-16 mx-auto mb-4" />
              <h4 className="font-bold text-[#2B3175] mb-2">Criadero Propio</h4>
              <p className="text-xs text-gray-500">Control total de calidad en nuestra línea de cerdos.</p>
            </div>
            <div className="p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <img src="https://api.iconify.design/lucide:beef.svg?color=%23E3343A" alt="Vaca" className="w-16 h-16 mx-auto mb-4" />
              <h4 className="font-bold text-[#2B3175] mb-2">Hacienda Directa</h4>
              <p className="text-xs text-gray-500">Compramos sin intermediarios para asegurar el mejor precio.</p>
            </div>
            <div className="p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <img src="https://api.iconify.design/lucide:drumstick.svg?color=%23E3343A" alt="Pollo" className="w-16 h-16 mx-auto mb-4" />
              <h4 className="font-bold text-[#2B3175] mb-2">Variedad Total</h4>
              <p className="text-xs text-gray-500">Cortes vacunos, cerdos y pollos frescos todos los días.</p>
            </div>
            <div className="p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <img src="https://api.iconify.design/lucide:truck.svg?color=%23E3343A" alt="Camión" className="w-16 h-16 mx-auto mb-4" />
              <h4 className="font-bold text-[#2B3175] mb-2">Mayor y Menor</h4>
              <p className="text-xs text-gray-500">Abastecemos al público general y a grandes comercios.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="col-span-1">
              <div className="flex items-center gap-2 mb-6">
                ...
                <div className="flex flex-col leading-tight">
                  <span className="text-white font-bold text-xs tracking-widest">ABASTECEDORA</span>
                  <span className="text-white font-black text-xl tracking-tight">VALETTE</span>
                </div>
              </div>
              <p className="text-gray-400 text-sm mb-6">
                Una experiencia de compra directa; sin intermediarios. Somos productores y tu mejor opción en carnes.
              </p>
            ...
            {/* Enlaces Rápidos */}
            <div>
              <h4 className="text-lg font-bold mb-6 border-b border-gray-700 pb-2">Navegación</h4>
              <ul className="space-y-3">
                <li><a href="#sucursales" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2"><ChevronRight size={14} className="text-[#E3343A]" /> Sucursales</a></li>
                <li><a href="#mayoristas" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2"><ChevronRight size={14} className="text-[#E3343A]" /> Venta Mayorista</a></li>
                <li><a href="#nosotros" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2"><ChevronRight size={14} className="text-[#E3343A]" /> Quiénes Somos</a></li>
              </ul>
            </div>

            {/* Contacto Rápido */}
            <div>
              <h4 className="text-lg font-bold mb-6 border-b border-gray-700 pb-2">Contacto Directo</h4>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <MapPin className="text-[#E3343A] mt-1 flex-shrink-0" size={18} />
                  <div>
                    <strong className="block text-sm">Luis Guillón</strong>
                    <span className="text-gray-400 text-sm">Av. Luciano Valette 1686</span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <MapPin className="text-[#E3343A] mt-1 flex-shrink-0" size={18} />
                  <div>
                    ...
                    <span className="text-gray-400 text-sm">Av. Libertador 3910</span>
                  </div>
                </li>
                <li className="flex items-center gap-3 pt-2">
                  <WhatsAppIcon className="text-[#E3343A] w-6 h-6" />
                  <a href="https://wa.me/541128353615" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#25D366] font-bold transition-colors">
                    +54 11 2835 3615
                  </a>
                </li>
              </ul>
