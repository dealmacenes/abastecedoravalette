...
import IconoMenu from "../../components/IconoMenu";
...
const AdminPanel = () => {
  ...
  return (
    <>
      <main>
        <header className="flex fixed z-10 top-0 w-full h-15 bg-neutral-900 border-b border-neutral-500 justify-between items-center px-3 lg:pl-0 lg:pr-8">
          {/* Home button */}
          <GoHomeButton/>

          {/* menu de navegación mobile */}
          <div className="flex mr-3 lg:mr-0 gap-5 lg:gap-0">
        ...
        <section className="flex lg:pl-[17.6rem] pt-15">
          <aside
            className="hidden flex-1 fixed top-15 left-0 lg:flex flex-col h-[calc(100vh-3.75rem)] pb-3 w-70 bg-neutral-950 border-r border-neutral-500 overflow-y-auto hide-scrollbar"
          >
            {/* Sidebar content */}
            <nav className="flex flex-col w-full h-fit mt-5 px-3">
              {adminSidebarItems.map((group, index) => (
